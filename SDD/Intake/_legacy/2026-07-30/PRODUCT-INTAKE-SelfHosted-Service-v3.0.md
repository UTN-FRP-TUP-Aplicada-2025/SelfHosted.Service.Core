...
|---|---|
| El archivo vivo pierde el sufijo de versión del nombre y pasa a declarar su versión en la cabecera. La copia superada se archiva como `_legacy/2026-07-28/PRODUCT-INTAKE-SelfHosted-Service-Core-v1.2.md` | D4 y D5 reformuladas en el conjunto 4.0 |
