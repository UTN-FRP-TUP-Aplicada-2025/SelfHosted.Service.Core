> **Archivado.** Estado: **Superado**. Este documento es la copia completa y autocontenida de la versión **3.2** de `PRODUCT-INTAKE-SelfHosted-Service.md`, archivada el 2026-07-30 antes de emitir la versión 3.3. La versión vigente es [`PRODUCT-INTAKE-SelfHosted-Service.md`](../../PRODUCT-INTAKE-SelfHosted-Service.md). El cuerpo que sigue no se modificó.
