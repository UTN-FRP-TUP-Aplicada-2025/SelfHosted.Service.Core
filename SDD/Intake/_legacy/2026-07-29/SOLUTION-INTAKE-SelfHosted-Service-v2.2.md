> **Bloque de archivado.** Estado: `Superado`. Copia completa y autocontenida de la versión 2.2 de `SOLUTION-INTAKE-SelfHosted-Service.md`, tomada el 2026-07-29 antes de incorporar el campo `Product Owner` que el conjunto normativo 4.1 del Framework SDD agrega a la cabecera del intake. Es la versión bajo la que se generó y auditó la Fase A. La versión vigente es `../../SOLUTION-INTAKE-SelfHosted-Service.md`. El cuerpo de este snapshot no se modifica.
