> **Bloque de archivado.** Estado: `Superado`. Copia completa y autocontenida de la versión 1.7 de `SOLUTION-MANIFEST-SelfHosted-Service.md`, tomada el 2026-07-29 antes de actualizar el bloque de procedencia del framework de 4.0 a 4.1. Es la primera versión de este manifiesto que llegó a confirmarse como canónica, y bajo ella se generó y auditó la Fase A. La versión vigente es `../../SOLUTION-MANIFEST-SelfHosted-Service.md`. El cuerpo de este snapshot no se modifica.
...
| Versión | 1.7 | — |
| Fecha | 2026-07-29 | — |
| Estado | **Vigente.** Confirmado como canónico por el agente humano del proyecto el 2026-07-29 | — |
