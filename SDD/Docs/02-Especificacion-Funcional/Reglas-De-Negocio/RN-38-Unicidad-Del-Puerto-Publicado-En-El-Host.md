...
| --- | --- | --- |
| 2.1 | 2026-07-30 | **Cambio de estatus de autoría, sin cambio de contenido normativo**, por la confirmación de `DI-17` que el agente humano del proyecto emitió el 2026-07-30 y que el `PRODUCT-INTAKE-SelfHosted-Service` v3.2 consolida en §19. Sube **minor**: **el enunciado, sus dos precisiones —que no aplica a macvlan y que sí alcanza a los servicios pendientes de aplicar—, el alcance declarado del informe, el momento de validación, la consecuencia, los casos de uso afectados y las pruebas previstas no cambian una palabra**. Lo único que cambia es la cabecera: el reparto en tres niveles de verificación con su límite declarado pasa de `[D-i]` **sin revisar** a **`[D]` confirmada**. La brecha de cobertura de prueba del anexo E-22, que es anterior a esta regla, **sigue abierta**. La versión 2.0 queda archivada en `_legacy/2026-07-30/RN-38-Unicidad-Del-Puerto-Publicado-En-El-Host-v2.0.md` |
