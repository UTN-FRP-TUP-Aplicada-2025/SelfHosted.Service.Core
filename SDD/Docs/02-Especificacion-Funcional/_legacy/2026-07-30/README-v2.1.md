> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `README.md`, versión **2.1**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1 al corregirse el hallazgo **P1-1** del informe [`B2-Retroalimentacion-Decisiones-2026-07-30-r1.md`](../../../Audit/B2-Retroalimentacion-Decisiones-2026-07-30-r1.md). La versión vigente es [`README.md`](../../README.md). **El cuerpo que sigue no se modificó.**
>
...
| CU-39 | **Nace de una decisión cerrada**, `Q-27`. Lo que sigue abierto es dónde se configura el registro explorable, su ámbito de credencial, y la superficie `SUP-19`, que `03-UX-UI-DX` debe emitir |
...
| --- | --- |
| 03-UX-UI-DX | Los flujos principales y alternativos de cada CU, sin su detalle visual, que es de esa categoría; el [glosario funcional](Glosario-Funcional.md), que su propio `Glosario-UX.md` debe referenciar y no duplicar; las tres brechas de maquetado que el anexo E-18 dejó abiertas (B-07); y **tres entregas nuevas del 2026-07-30**: la superficie `SUP-19` de exploración de registro de imágenes, que la decisión `Q-27` declara como consecuencia y que esta categoría propone sin emitir (B-25); el **umbral y el lugar** de la sugerencia de limpieza, que el intake delega explícitamente a esa categoría (B-26); y la revisión de `SUP-18`, que la decisión de `Q-17` desbloquea |
