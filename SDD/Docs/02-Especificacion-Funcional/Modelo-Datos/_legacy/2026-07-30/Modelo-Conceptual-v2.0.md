> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `Modelo-Conceptual.md`, versión **2.0**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1 al incorporarse la ronda de decisiones del agente humano del proyecto del 2026-07-30 —`Q-15`, `Q-17`, `Q-27` y la confirmación de `DI-17` a `DI-19`—. La versión vigente es [`Modelo-Conceptual.md`](../../Modelo-Conceptual.md). **El cuerpo que sigue no se modificó.**
>
