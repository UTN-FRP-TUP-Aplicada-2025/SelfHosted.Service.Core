...
**Trazabilidad upstream:** PRODUCT-INTAKE anexo E-9, tabla `enlaces`, restricción de unicidad sobre origen, clave de variable, destino y clave de destino
