...
**Trazabilidad upstream:** PRODUCT-INTAKE anexo E-9, tabla `enlaces`, condición que exige origen distinto de destino; E-2, verificación de que una referencia a variables del propio servicio no genera arista
