...
**Trazabilidad upstream:** PRODUCT-INTAKE anexo E-9, tablas `variables` y `variables_proyecto`, nota que declara el valor ausente cuando la variable es secreta; E-16 RN-15 y RN-23
