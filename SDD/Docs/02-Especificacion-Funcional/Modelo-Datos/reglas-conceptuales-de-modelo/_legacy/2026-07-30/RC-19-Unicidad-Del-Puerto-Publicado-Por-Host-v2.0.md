> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `RC-19-Unicidad-Del-Puerto-Publicado-Por-Host.md`, versión **2.0**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1 al incorporarse la ronda de decisiones del agente humano del proyecto del 2026-07-30 —`Q-15`, `Q-17`, `Q-27` y la confirmación de `DI-17` a `DI-19`—. La versión vigente es [`RC-19-Unicidad-Del-Puerto-Publicado-Por-Host.md`](../../RC-19-Unicidad-Del-Puerto-Publicado-Por-Host.md). **El cuerpo que sigue no se modificó.**
>
...
**Trazabilidad upstream:** PRODUCT-INTAKE anexo E-16, fila RN-38, y anexo E-2 §20.2.5, informe de configuración con el hallazgo de colisión de puerto; anexo E-7, campo de puertos publicados del candidato y regla RA-07. **Autoría declarada en la fuente:** **[D-i]**, especificación de integración `DI-17`, **sin revisar**.
