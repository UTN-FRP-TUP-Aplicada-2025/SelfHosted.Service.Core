...
- **Brecha cerrada, `Q-27`: hay exploración de registro de imágenes.** La versión anterior declaraba que, con el catálogo vacío en una instalación nueva y sin ninguna forma declarada de explorar un registro, un administrador que no sabía la dirección de la imagen no tenía camino en su primer minuto de uso, y que FA-01 mitigaba **la mitad** del problema. El agente humano del proyecto decidió el 2026-07-30 que **hay exploración**: la otra mitad la cubre [CU-39](CU-39-Exploracion-Del-Registro-De-Imagenes.md), y la derivación de FA-01 a las otras vías de alta pasa a tener un destino concreto en las dos vías de imagen. **El catálogo sigue arrancando vacío**: la decisión no introduce contenido de fábrica y FA-01 no cambia. La fila se conserva en lugar de borrarse porque otros artefactos citan el identificador.
...
| --- | --- | --- |
| 2.1 | 2026-07-30 | **Cierre de la brecha `Q-27`**, por la decisión del agente humano del proyecto del 2026-07-30 consolidada en el `PRODUCT-INTAKE-SelfHosted-Service` v3.2 §19: **hay exploración de registro de imágenes**. Sube **minor** y **es el único cambio de contenido**: la nota de §10 pasa de brecha abierta a brecha cerrada, conservando su fila, y remite a [CU-39](CU-39-Exploracion-Del-Registro-De-Imagenes.md), que es donde la capacidad vive. Ningún propósito, actor, precondición, flujo, flujo alternativo, excepción, postcondición ni criterio de aceptación cambia: **el catálogo sigue arrancando vacío en una instalación nueva** y `FA-01` no se toca, porque la decisión no introduce contenido de fábrica. Las notas de `DI-21` y `DI-22` **siguen declarándose sin revisar**, porque esas dos no entraron en la ronda del 2026-07-30. La versión 2.0 queda archivada en `_legacy/2026-07-30/CU-17-Mantenimiento-Del-Catalogo-v2.0.md` |
