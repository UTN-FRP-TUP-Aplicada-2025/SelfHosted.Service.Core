> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `CU-38-Vuelta-A-Un-Despliegue-Anterior.md`, versión **2.0**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1 al incorporarse la ronda de decisiones del agente humano del proyecto del 2026-07-30 —`Q-15`, `Q-17`, `Q-27` y la confirmación de `DI-17` a `DI-19`—. La versión vigente es [`CU-38-Vuelta-A-Un-Despliegue-Anterior.md`](../../CU-38-Vuelta-A-Un-Despliegue-Anterior.md). **El cuerpo que sigue no se modificó.**
>
...
**Trazabilidad upstream:** PRODUCT-INTAKE anexo E-23 (el bloque de imagen del despliegue y el digesto como identidad real); anexo E-3 (el despliegue con su línea de tiempo); anexo E-17 (la máquina de estados del despliegue); §17.P.11 DA-07, la retención de cincuenta despliegues por servicio; E-16 RN-13, RN-17, RN-24, RN-31, RN-40
