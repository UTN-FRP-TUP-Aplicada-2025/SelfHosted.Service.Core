...
**Trazabilidad upstream:** SOLUTION-INTAKE §4 capacidad F-04; §5 historia 3; anexo E-1 (la disposición como bloque del proyecto); anexo E-15, endpoint de guardado del lienzo; §17.P.10, regla de oro del lienzo; §17.P.11, decisión de guardar la disposición en un único bloque; E-16 RN-12
...
| Actor | Tipo | Rol |
| --- | --- | --- |
| Administrador de la solución | Primario | Desplaza, agrupa y acerca los nodos del lienzo |
| Registro de la solución | Sistema | Persiste la disposición al finalizar el gesto y la restituye al abrir el proyecto |
