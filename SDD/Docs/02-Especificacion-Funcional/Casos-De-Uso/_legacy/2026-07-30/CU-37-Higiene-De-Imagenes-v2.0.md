> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `CU-37-Higiene-De-Imagenes.md`, versión **2.0**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1 al incorporarse la ronda de decisiones del agente humano del proyecto del 2026-07-30 —`Q-15`, `Q-17`, `Q-27` y la confirmación de `DI-17` a `DI-19`—. La versión vigente es [`CU-37-Higiene-De-Imagenes.md`](../../CU-37-Higiene-De-Imagenes.md). **El cuerpo que sigue no se modificó.**
>
...
**Trazabilidad upstream:** PRODUCT-INTAKE anexo E-23 (la imagen como objeto con identidad, sus tres campos determinantes y las siete decisiones que deja abiertas); anexo E-3 y §17.P.11 DA-07, la retención de despliegues por servicio; §17.P.10, requerimientos no funcionales de recursos del servidor; E-16 RN-17, RN-40
