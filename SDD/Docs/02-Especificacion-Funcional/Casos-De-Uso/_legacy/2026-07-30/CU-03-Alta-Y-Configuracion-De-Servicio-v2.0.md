...
| Actor | Tipo | Rol |
| --- | --- | --- |
| Administrador de la solución | Primario | Elige la vía de alta, declara y edita la configuración del servicio |
| Registro de la solución | Sistema | Valida las reglas de nombre, red, puertos, recursos y variables, y persiste la configuración en cualquier estado |
