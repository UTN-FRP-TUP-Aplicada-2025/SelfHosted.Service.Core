...
**Trazabilidad upstream:** SOLUTION-INTAKE §7 CL-02 y CL-03; anexo E-17 (la tabla de correspondencia y el alcance por contenedor de la máquina de estados); §11 riesgo RG-08; §17.P.10, suscripción a eventos y reconciliación periódica; E-16 RN-31, RN-20
...
Mantener el estado registrado alineado con lo que el motor de contenedores efectivamente ejecuta, y señalar como huérfano el servicio cuyo contenedor desapareció, para que la deriva producida por operar contenedores por fuera de la solución deje de ser invisible.
...
| Administrador de la solución | Secundario | Ve el resultado de la reconciliación en el lienzo y en el tablero |
...
| Contenedor operado por fuera | Alguien crea, detiene o elimina contenedores sin pasar por la solución | La reconciliación lo detecta y lo refleja; el estado huérfano es la señal explícita de esa deriva (RG-08, CL-02) |
