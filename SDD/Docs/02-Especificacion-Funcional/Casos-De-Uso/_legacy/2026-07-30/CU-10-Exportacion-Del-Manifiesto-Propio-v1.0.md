...
**Trazabilidad upstream:** SOLUTION-INTAKE §4 capacidad F-13; anexo E-14 (el manifiesto propio y qué preserva); anexo E-1 (la disposición del lienzo); anexo E-4 (la forma legible frente a la forma vinculada); E-16 RN-15, RN-25
...
| Actor | Tipo | Rol |
| --- | --- | --- |
| Administrador de la solución | Primario | Solicita el manifiesto propio del proyecto SelfHosted |
