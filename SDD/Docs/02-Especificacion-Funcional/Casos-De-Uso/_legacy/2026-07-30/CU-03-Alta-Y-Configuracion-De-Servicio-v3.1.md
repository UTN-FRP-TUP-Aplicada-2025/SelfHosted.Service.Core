> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `CU-03-Alta-Y-Configuracion-De-Servicio.md`, versión **3.1**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1 al corregirse el hallazgo **P1-1** del informe [`B2-Retroalimentacion-Decisiones-2026-07-30-r1.md`](../../../../Audit/B2-Retroalimentacion-Decisiones-2026-07-30-r1.md). La versión vigente es [`CU-03-Alta-Y-Configuracion-De-Servicio.md`](../../CU-03-Alta-Y-Configuracion-De-Servicio.md). **El cuerpo que sigue no se modificó.**
>
