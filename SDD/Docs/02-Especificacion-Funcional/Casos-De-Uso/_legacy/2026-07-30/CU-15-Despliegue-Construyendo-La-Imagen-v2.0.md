> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `CU-15-Despliegue-Construyendo-La-Imagen.md`, versión **2.0**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1 al incorporarse la ronda de decisiones del agente humano del proyecto del 2026-07-30 —`Q-15`, `Q-17`, `Q-27` y la confirmación de `DI-17` a `DI-19`—. La versión vigente es [`CU-15-Despliegue-Construyendo-La-Imagen.md`](../../CU-15-Despliegue-Construyendo-La-Imagen.md). **El cuerpo que sigue no se modificó.**
>
...
- **Brecha declarada, `Q-15` y `Q-16`:** el registro del digesto y de la marca de pertenencia de la imagen construida, del paso 6, **depende de dos decisiones abiertas**. Sin la marca de pertenencia el producto no puede distinguir lo que construyó de lo ajeno, y ninguna limpieza de imágenes es segura (RN-40, CU-37). Destinatario: agente humano del proyecto.
