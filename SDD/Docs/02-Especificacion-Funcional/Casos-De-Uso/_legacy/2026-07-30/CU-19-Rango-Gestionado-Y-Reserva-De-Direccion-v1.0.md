...
**Trazabilidad upstream:** SOLUTION-INTAKE §4 capacidad F-08; anexo E-8 (el rango gestionado, sus exclusiones y las reservas); anexo E-15, endpoint de estado de reservas y conflictos; §17.P.11 DA-04; §17.P.4, decisión de esquema 1; E-16 RN-03, RN-06, RN-18
...
Permitir que el administrador declare el rango de direcciones que la solución gestiona y reserve una dirección por servicio y por réplica, para que las direcciones fijas dejen de anotarse fuera del sistema.

## 2. Actores

| Actor | Tipo | Rol |
| --- | --- | --- |
| Administrador de la solución | Primario | Declara el rango gestionado, sus exclusiones y las reservas de cada servicio |
