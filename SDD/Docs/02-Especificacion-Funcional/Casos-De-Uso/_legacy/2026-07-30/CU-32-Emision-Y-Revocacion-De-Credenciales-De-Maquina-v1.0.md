...
**Trazabilidad upstream:** SOLUTION-INTAKE §4 capacidad F-15; §5 historia 10; anexo E-12 (la carga útil del token emitido); §17.P.5, ámbitos, vigencia y revocación; §11 riesgo RG-03; E-16 RN-15, RN-16, RN-17
...
| Actor | Tipo | Rol |
| --- | --- | --- |
| Administrador de la solución | Primario | Emite, lista y revoca los tokens de API |
| Registro de la solución | Sistema | Genera el token, muestra su valor una única vez, persiste sólo su resumen y aplica la revocación |
