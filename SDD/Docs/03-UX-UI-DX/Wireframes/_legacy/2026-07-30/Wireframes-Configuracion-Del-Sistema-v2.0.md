> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `Wireframes-Configuracion-Del-Sistema.md`, versión **2.0**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1, al propagarse la retroalimentación del paso 6 de la Fase B2: las decisiones `Q-15`, `Q-17` y `Q-27` del agente humano del proyecto del 2026-07-30, que cierran la brecha `B-UX-30`. La versión vigente es [`Wireframes-Configuracion-Del-Sistema.md`](../../Wireframes-Configuracion-Del-Sistema.md). **El cuerpo que sigue no se modificó.**
>
