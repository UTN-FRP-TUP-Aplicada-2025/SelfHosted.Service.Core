...
2. **La adopción va primero.** Es la que resuelve el primer uso sobre un servidor que ya está en producción, que es el caso declarado del administrador de esta solución, y la que no exige saber ninguna dirección de imagen.
