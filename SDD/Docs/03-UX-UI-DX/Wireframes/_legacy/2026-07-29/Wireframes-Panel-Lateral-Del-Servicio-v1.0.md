> **Bloque de archivado.** Estado: `Superado`. Copia completa y autocontenida de la versión 1.0 de `Wireframes-Panel-Lateral-Del-Servicio.md`, tomada el 2026-07-29 antes de incorporar a la especificación las definiciones de alta y configuración de servicios y de ítems del catálogo que `SDD/Estado/Redefinicion-Servicio.md` v2.0 establece en su parte normativa (§16 a §23). La versión vigente es `../../Wireframes-Panel-Lateral-Del-Servicio.md`. El cuerpo de este snapshot no se modifica.
...
**Presets.** `Design-Rules-Config-Esquema.md` §4.4 admite presets cuando aplican, y exige que sus valores se compongan a partir de los ejemplos y los valores por defecto de los descriptores, nunca de literales escritos en la pantalla. Ninguna fuente de esta solución declara presets de configuración de servicio, y sin ejemplos declarados en los descriptores no hay de dónde componerlos. **No se especifican presets en esta superficie**, y la ausencia se declara para que no se lea como omisión.
