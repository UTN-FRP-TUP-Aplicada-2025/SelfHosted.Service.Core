> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `Experiencia-De-Uso.md`, versión **2.0**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1, al incorporarse la retroalimentación del paso 6 de la Fase B2: las decisiones `Q-15`, `Q-17`, `Q-27` y la resolución de `PA-15` del agente humano del proyecto del 2026-07-30. La versión vigente es [`Experiencia-De-Uso.md`](../../Experiencia-De-Uso.md). **El cuerpo que sigue no se modificó.**
>
