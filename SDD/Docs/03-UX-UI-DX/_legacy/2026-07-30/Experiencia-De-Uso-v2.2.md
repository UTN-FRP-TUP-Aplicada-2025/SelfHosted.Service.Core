> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `Experiencia-De-Uso.md`, versión **2.2**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1, al corregirse el hallazgo `P2` del informe de audit `B2-Retroalimentacion-Decisiones-2026-07-30-r1.md`: cifras autorreferenciales que no se sostenían al contarlas en disco. La versión vigente es [`Experiencia-De-Uso.md`](../../Experiencia-De-Uso.md). **El cuerpo que sigue no se modificó.**
>
