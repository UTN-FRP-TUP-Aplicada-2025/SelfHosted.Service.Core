> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `README.md`, versión **2.2**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1, al corregirse el hallazgo `P2` del informe de audit `B2-Retroalimentacion-Decisiones-2026-07-30-r1.md`: cifras autorreferenciales que no se sostenían al contarlas en disco. La versión vigente es [`README.md`](../../README.md). **El cuerpo que sigue no se modificó.**
>
...
| --- | --- | --- |
| **2.2** | 3 | Este índice, el marco de experiencia y el glosario, que la segunda ronda vuelve a tocar por el cierre de `B-UX-30` |
| **2.1** | 6 | Los wireframes de `SUP-06`, `SUP-09`, `SUP-11`, `SUP-12`, `SUP-17` y `SUP-18` |
| **1.0** | 1 | El wireframe de `SUP-19`, **nuevo** |
| **2.0** | 16 | Los trece wireframes restantes y las cuatro representaciones, **que no se tocaron** |
...
Las once primeras corresponden a nodos del mapa de navegación del anexo E-18 del intake; **las ocho últimas** declaran de dónde salen, porque ese anexo no las maqueta. Trece están en versión 2.0; `SUP-06`, `SUP-09`, `SUP-11`, `SUP-12`, `SUP-17` y `SUP-18` en 2.1; y `SUP-19` en 1.0.
