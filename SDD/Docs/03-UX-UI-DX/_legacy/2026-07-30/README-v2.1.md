> **Documento archivado.** Estado: **Superado**. Es la copia completa del estado previo de `README.md`, versión **2.1**, archivada el 2026-07-30 por la política de deprecación de `Master-Prompt.md` §5.1, al cerrarse la brecha `B-UX-30` con la propagación de la retroalimentación del paso 6 de la Fase B2 a `SUP-06`, `SUP-09`, `SUP-11` y `SUP-12`. La versión vigente es [`README.md`](../../README.md). **El cuerpo que sigue no se modificó.**
>
...
- [7. Brechas abiertas de esta categoría](#7-brechas-abiertas-de-esta-categoría)
  ...
  - [7.3 Las veintitrés restantes, por destinatario](#73-las-veintitrés-restantes-por-destinatario)
...
| --- | --- | --- |
| [Experiencia-De-Uso.md](Experiencia-De-Uso.md) | 2.1 | Marco de experiencia: audiencia, principios, ocho flujos clave, estados, accesibilidad, internacionalización, performance percibida, errores, trazabilidad, notas y control de cambios |
| [Glosario-UX.md](Glosario-UX.md) | 2.1 | Términos de superficie, de estado, de las cuatro capacidades transversales y de forma del artefacto; los términos referenciados a los dos glosarios upstream; la familia polisémica «resolución»; y las elecciones de microcopy fijadas |

### 4.2 Superficies

Las once primeras corresponden a nodos del mapa de navegación del anexo E-18 del intake; **las ocho últimas** declaran de dónde salen, porque ese anexo no las maqueta. Diecisiete están en versión 2.0, `SUP-17` y `SUP-18` en 2.1, y `SUP-19` en 1.0.
...
| `03-UX-UI-DX`, en la ronda que alcance las cuatro superficies que ésta no tocó | `B-UX-30` propagación pendiente a `SUP-06`, `SUP-09`, `SUP-11` y `SUP-12` |
...
| `SUP-09` · Tablero de estado | **Ajustar** | Pasa a alojar la **ubicación secundaria** de la sugerencia de limpieza: una línea con el espacio recuperable y un enlace a `SUP-18`, **sin detalle y sin acción de confirmar**. Su wireframe todavía no lo declara: brecha `B-UX-30` |
| `SUP-12` · Configuración del sistema | **Ajustar** | Pasa a alojar los **descriptores del umbral** de la sugerencia, junto a los parámetros de retención. Su wireframe todavía no lo declara: brecha `B-UX-30` |

Las catorce superficies restantes **no cambian** y la maqueta las conserva como estén.
