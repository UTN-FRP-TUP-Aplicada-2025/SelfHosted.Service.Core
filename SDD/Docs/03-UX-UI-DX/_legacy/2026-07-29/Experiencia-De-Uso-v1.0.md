> **Bloque de archivado.** Estado: `Superado`. Copia completa y autocontenida de la versión 1.0 de `Experiencia-De-Uso.md`, tomada el 2026-07-29 antes de incorporar a la especificación las definiciones de alta y configuración de servicios y de ítems del catálogo que `SDD/Estado/Redefinicion-Servicio.md` v2.0 establece en su parte normativa (§16 a §23). La versión vigente es `../../Experiencia-De-Uso.md`. El cuerpo de este snapshot no se modifica.
...
Dieciséis superficies. Las once primeras corresponden a nodos del mapa de navegación del anexo E-18; las cinco últimas declaran de dónde salen, porque E-18 no las maqueta.
...
| SUP-06 | Panel lateral del servicio | [`Wireframes-Panel-Lateral-Del-Servicio.md`](Wireframes/Wireframes-Panel-Lateral-Del-Servicio.md) | Panel contextual del lienzo | CU-03, CU-13, CU-15, CU-18, CU-19, CU-35 | E-18 panel lateral de servicio |
...
El mínimo que la tabla de adaptabilidad fija para `web-monolith` es de cuatro superficies clave. E-18 declara más, y la cobertura de los casos de uso con interacción humana relevante lleva la cuenta a dieciséis.
...
Los 36 casos de uso de `02-Especificacion-Funcional`, con la superficie que los materializa. Ningún caso de uso con interacción humana queda sin superficie.

| CU | Superficies | CU | Superficies |
| --- | --- | --- | --- |
| CU-01 | SUP-04 | CU-19 | SUP-06, SUP-12 |
| CU-02 | SUP-04 | CU-20 | SUP-14 |
| CU-03 | SUP-05, SUP-06 | CU-21 | SUP-14 |
...
| CU-13 | SUP-05, SUP-06 | CU-31 | SUP-03 |
| CU-14 | SUP-08 | CU-32 | SUP-12 |
| CU-15 | SUP-05, SUP-06 | CU-33 | **Sin superficie.** Ver la nota siguiente |
| CU-16 | SUP-05, SUP-11 | CU-34 | SUP-13 |
