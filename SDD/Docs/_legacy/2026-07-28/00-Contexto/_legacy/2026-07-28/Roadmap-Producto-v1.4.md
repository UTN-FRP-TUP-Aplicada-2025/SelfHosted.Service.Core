...
**Documento:** Roadmap-Producto-v1.4.md
**Versión:** 1.4
**Estado:** Propuesto
**Fecha:** 2026-07-28
...
Las capacidades F-23, variables compartidas del proyecto, y F-24, referencias entre variables, se incorporaron al alcance el 2026-07-28 por decisión del agente humano del proyecto y no tienen fase ni corte vertical asignado. Este roadmap no se lo inventa, y el motivo es que la asignación no está disponible: los diez cortes verticales del Alcance 1 están declarados de forma cerrada por el cliente y ninguna de las dos figura entre ellos, de modo que ubicarlas exige decidir si abren un corte propio o se suman a uno existente. Esa decisión no es de este documento.
...
La tercera es de orden entre las dos capacidades nuevas: F-24 puede referenciar una variable compartida, así que si entran en fases distintas, F-23 va primero o F-24 entra sin esa de sus tres formas.
...
|---|---|
| 06-Backlog | Las veintiuna épicas de §2.2, EPC-01 y EPC-02 de cimientos más EP-01 a EP-17, EP-23 y EP-24 de capacidad, con su capacidad asociada y su fase, como estructura del backlog. EP-23 y EP-24 entran al backlog sin fase asignada, según §2.4. La nota de §2.3 marca qué reparto necesita confirmación antes de tratarse como cerrado |
