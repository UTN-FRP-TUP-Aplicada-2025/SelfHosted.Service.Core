...
|---|---|---|---|
| 1 | [Vision-Producto](Vision-Producto-v1.4.md) | Por qué existe el sistema: problema de negocio, audiencia, propuesta de valor, visión a tres años, objetivos SMART, métricas de éxito, restricciones, riesgos y glosario del dominio | Propuesto |
| 2 | [Alcance-Proyecto](Alcance-Proyecto-v1.4.md) | Qué entra y qué no entra: capacidades, entregables, ambientes, exclusiones justificadas, supuestos, criterios de aceptación y gestión de cambios de alcance | Propuesto |
| 3 | [Roadmap-Producto](Roadmap-Producto-v1.4.md) | En qué secuencia se construye: fases, épicas, etapas, dependencias, puertas técnicas y criterios verificables de transición | Propuesto |
...
| 4 | Qué hace la instanciación de un ítem del catálogo cuando un nombre de servicio que trae ya existe en el proyecto destino | `Alcance-Proyecto` §6.2 | La especificación del caso de uso de alta desde catálogo en 02-Especificacion-Funcional |
| 5 | Qué hace la instanciación cuando la plantilla trae una variable compartida cuya clave ya existe en el proyecto destino | `Alcance-Proyecto` §6.2 | La misma especificación en 02-Especificacion-Funcional. Elegir mal expone la credencial de un conjunto de servicios a otro |
| 6 | En qué fase y en qué corte vertical entran las capacidades nuevas F-23 y F-24 | `Roadmap-Producto` §2.4 | La secuencia de etapas de 07-Plan-Sprint. Los diez cortes del primer alcance están cerrados y ninguna de las dos figura entre ellos |
