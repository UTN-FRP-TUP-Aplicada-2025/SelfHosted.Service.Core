...
**Documento:** Vision-Producto-v1.1.md
**Versión:** 1.1
**Estado:** Propuesto
**Fecha:** 2026-07-28
...
El avance hacia ese estado no se mide por fechas de calendario. El plazo declarado por el cliente es explícitamente "sin fecha objetivo": el progreso se mide por etapas cerradas, cada una con su punto de control aprobado. La secuencia de alcances y las condiciones de transición están en `Roadmap-Producto-v1.1.md`.
...
El detalle de cada exclusión, con su justificación y su versión futura tentativa, está en `Alcance-Proyecto-v1.1.md` §5.
...
| RE-10 | Flujo de trabajo obligatorio | Una rama y un pull request por etapa, siendo el pull request el punto de control; etiqueta por etapa cerrada; ningún secreto entra al repositorio | Las reglas operativas están en `Acuerdo-Equipo-v1.1.md` |
...
| Arista o enlace | Conexión dibujada en el lienzo. Representa que un servicio consume, por variable de entorno, un dato de otro servicio del mismo proyecto. Tiene dos orígenes posibles: el enlace de host y puerto, que aporta la dirección y el puerto del destino, y la referencia de variable, que aporta el valor de una variable del destino | Enlace. Es un único tipo de arista con dos orígenes, no dos tipos distintos |
...
| Referencia de variable | Valor de una variable expresado como un apuntador a otra variable en lugar de como literal: a otra del propio servicio, a una compartida del proyecto o a una de otro servicio del mismo proyecto | El contenedor nunca ve el apuntador, ve el valor ya resuelto. La sintaxis concreta es materia de 02-Especificacion-Funcional |
