...
**Documento:** Vision-Producto-v1.4.md
**Versión:** 1.4
**Estado:** Propuesto
**Fecha:** 2026-07-28
...
| Referencia de variable | Valor de una variable expresado como un apuntador a otra variable en lugar de como literal: a otra del propio servicio, a una compartida del proyecto o a una de otro servicio del mismo proyecto | Cuando apunta a otro servicio queda vinculada a ese servicio y no a su nombre, de modo que renombrarlo no la rompe: renombrar es una operación de presentación. El contenedor nunca ve el apuntador, ve el valor ya resuelto. La sintaxis concreta es materia de 02-Especificacion-Funcional |
...
| Variable compartida del proyecto | Variable definida una sola vez a nivel proyecto y referenciable desde cualquiera de sus servicios. Puede ser secreta, con el mismo tratamiento que cualquier otro secreto | Resuelve el valor que hoy hay que repetir y mantener sincronizado servicio por servicio |
