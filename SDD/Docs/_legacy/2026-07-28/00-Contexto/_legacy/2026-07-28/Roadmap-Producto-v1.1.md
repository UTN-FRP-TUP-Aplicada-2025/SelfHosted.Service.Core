...
**Documento:** Roadmap-Producto-v1.1.md
**Versión:** 1.1
**Estado:** Propuesto
**Fecha:** 2026-07-28
...
| EP-24 | Sin fase asignada, ver §2.4 | F-24 | Referencias entre variables, para que un valor se defina en un solo lugar en vez de repetirse |
...
Dos consecuencias para quien planifique. La primera es de dependencia: las dos capacidades operan sobre la configuración de un servicio y sobre el grafo del proyecto, de modo que ninguna puede ubicarse antes de EP-03 ni de EP-04, y F-24 genera aristas, lo que la ata también al corte del lienzo. La segunda es de orden entre ellas: F-24 puede referenciar una variable compartida, así que si las dos entran en fases distintas, F-23 va primero o F-24 entra sin esa de sus tres formas.
...
Desviación declarada respecto de la tabla tipo. Las reglas de la categoría nombran esta matriz por fase, épica, sprint y release, y su columna de cantidad como "sprints estimados". Este documento sustituye sprint por etapa en el título de la sección, en el encabezado de la columna y en el cuerpo, porque el modelo de gestión que el cliente declaró no tiene sprints de duración fija: la unidad de entrega es la etapa, con su rama, su pull request, su guion de demostración y su informe de cierre. La equivalencia es uno a uno, sprint igual a etapa, y así debe leerla la categoría 07-Plan-Sprint. Ver `Acuerdo-Equipo-v1.1.md` §2.1.
