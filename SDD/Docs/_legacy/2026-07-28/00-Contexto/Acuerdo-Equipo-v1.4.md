...
**Documento:** Acuerdo-Equipo-v1.4.md
**Versión:** 1.4
**Estado:** Propuesto
**Fecha:** 2026-07-28
**Autor:** Product Manager Senior (AG-00) en conjunción con Analista de Negocio Senior (AG-01)
**Trazabilidad upstream:** SOLUTION-INTAKE v1.2 cabecera y tabla de estado de supuestos, §2, §10, §15, §15.1, §17.1 P.6, §17.1 P.7, §17.1 P.8, §17.2 P.6, §17.3 P.6, §17.3 P.8, §17.4 P.6, §17.4 P.8
...
| Revisión de alcance | Sólo dentro de un punto de control | Lo que lleve clasificar el pedido y decidir qué se posterga | Agente humano y equipo | Una etapa en curso no cambia de alcance. Ver `Alcance-Proyecto` §9 |
...
| AT-11 | SemVer 2.0.0 como esquema de versión, único para los cuatro proyectos de código, porque se despliegan como un único artefacto | La versión calculada en el pipeline es única |
...
Los umbrales de DoD-03 provienen de S-02, propuesto por el intake y confirmado sin cambios por el agente humano del proyecto el 2026-07-27, según la tabla de estado de supuestos del SOLUTION-INTAKE v1.2. Son control bloqueante del pipeline, no una meta indicativa.
