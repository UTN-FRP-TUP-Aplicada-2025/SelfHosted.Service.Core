...
**Documento:** Roadmap-Producto-v1.5.md
**Versión:** 1.5
**Estado:** Propuesto
**Fecha:** 2026-07-28
**Autor:** Product Manager Senior (AG-00) en conjunción con Analista de Negocio Senior (AG-01)
**Trazabilidad upstream:** SOLUTION-INTAKE v1.2 §4, §8, §10, §11, §15, §15.1, §18
...
- [2. Fases del producto](#2-fases-del-producto)
  ...
  - [2.4 Capacidades sin fase asignada](#24-capacidades-sin-fase-asignada)
...
| EP-14 | Fase 3 | F-14 | Catálogo de plantillas reutilizables, editable, exportable e importable. Es la cuarta vía de alta de un servicio, y un ítem puede traer uno o varios servicios con sus dependencias |
...
| EP-23 | Sin fase asignada, ver §2.4 | F-23 | Variables compartidas del proyecto, definidas una vez y referenciables desde cualquiera de sus servicios |
| EP-24 | Sin fase asignada, ver §2.4 | F-24 | Referencias entre variables, para que un valor se defina en un solo lugar en vez de repetirse. Es además el mecanismo con el que se traza un vínculo en el lienzo |
| EP-25 | Sin fase asignada, ver §2.4 | F-25 | Higiene del modelo: el sistema advierte, sin bloquear, las condiciones que conviene revisar |
...
### 2.4 Capacidades sin fase asignada

Las capacidades F-23, variables compartidas del proyecto, F-24, referencias entre variables, y F-25, higiene del modelo, se incorporaron al alcance el 2026-07-28 por decisión del agente humano del proyecto y no tienen fase ni corte vertical asignado. Este roadmap no se lo inventa, y el motivo es que la asignación no está disponible: los diez cortes verticales del Alcance 1 están declarados de forma cerrada por el cliente y ninguna de las dos figura entre ellos, de modo que ubicarlas exige decidir si abren un corte propio o se suman a uno existente. Esa decisión no es de este documento.

| Épica | Capacidad | Estado de asignación | Quién resuelve |
|---|---|---|---|
| EP-23 | F-23, variables compartidas del proyecto | Sin fase ni corte asignado. Pendiente declarada en el SOLUTION-INTAKE §19 | 07-Plan-Sprint de SelfHosted-Web, con confirmación del agente humano del proyecto |
| EP-24 | F-24, referencias entre variables | Sin fase ni corte asignado. Pendiente declarada en el SOLUTION-INTAKE §19 | 07-Plan-Sprint de SelfHosted-Web, con confirmación del agente humano del proyecto |
| EP-25 | F-25, higiene del modelo | Sin fase ni corte asignado. Pendiente declarada en el SOLUTION-INTAKE §19, junto a las otras dos | 07-Plan-Sprint de SelfHosted-Web, con confirmación del agente humano del proyecto |

Tres consecuencias para quien planifique. La primera es de dependencia: las dos capacidades operan sobre la configuración de un servicio y sobre el grafo del proyecto, de modo que ninguna puede ubicarse antes de EP-03.

La segunda cambió el 2026-07-28 y hay que mirarla al planificar: el vínculo entre servicios pasó a ser un mecanismo único, y trazar una arista en el lienzo es escribir una referencia. Eso invierte la relación que este roadmap suponía entre EP-04 y EP-24: la referencia dejó de ser una capacidad que se apoya en el lienzo y pasó a ser aquello sobre lo que el lienzo se apoya. El corte del lienzo, que es una etapa del primer alcance, necesita el mecanismo de referencia al menos en su forma mínima, la que apunta a la dirección del destino. Quien asigne EP-24 a una fase tiene que resolver esa tensión: o el corte del lienzo incorpora esa forma mínima, o EP-24 entra antes que él. La tercera pasada sobre el intake, del 2026-07-28, aflojó algo esa tensión sin disolverla: una arista puede existir sin variable de por medio cuando su única razón es esperar al destino, de modo que el corte del lienzo puede entregar la dependencia de orden sin depender del mecanismo completo de referencias.

La tercera es de orden entre las tres capacidades nuevas: F-24 puede referenciar una variable compartida, así que si entran en fases distintas, F-23 va primero o F-24 entra sin esa de sus tres formas. Y F-25 va después de las dos, porque las condiciones que advierte son en su mayoría condiciones sobre variables compartidas y referencias: adelantarla dejaría a la capacidad sin nada que detectar.

Mientras la asignación no se resuelva, las dos capacidades no participan de ningún criterio de transición de §5: una fase no se puede bloquear por una capacidad que no le fue asignada.
...
Desviación declarada respecto de la tabla tipo. Las reglas de la categoría nombran esta matriz por fase, épica, sprint y release, y su columna de cantidad como "sprints estimados". Este documento sustituye sprint por etapa en el título de la sección, en el encabezado de la columna y en el cuerpo, porque el modelo de gestión que el cliente declaró no tiene sprints de duración fija: la unidad de entrega es la etapa, con su rama, su pull request, su guion de demostración y su informe de cierre. La equivalencia es uno a uno, sprint igual a etapa, y así debe leerla la categoría 07-Plan-Sprint. Ver `Acuerdo-Equipo` §2.1.
...
| Sin asignar | EP-23 | Pendiente de asignación, ver §2.4 | Hito demostrable | F-23 | Etiqueta por etapa, serie 0.x |
| Sin asignar | EP-24 | Pendiente de asignación, ver §2.4 | Hito demostrable | F-24 | Etiqueta por etapa, serie 0.x |
| Sin asignar | EP-25 | Pendiente de asignación, ver §2.4 | Hito demostrable | F-25 | Etiqueta por etapa, serie 0.x |
...
|---|---|---|
| — | Fase 0 | - [ ] El intake está aprobado y el manifiesto de la solución derivado.<br>- [ ] Las decisiones de producto pendientes están registradas y asignadas al cliente, y ninguna alcanza a una etapa de esta fase. |
...
|---|---|
| 06-Backlog | Las veintidós épicas de §2.2, EPC-01 y EPC-02 de cimientos más EP-01 a EP-17 y EP-23 a EP-25 de capacidad, con su capacidad asociada y su fase, como estructura del backlog. EP-23, EP-24 y EP-25 entran al backlog sin fase asignada, según §2.4. La nota de §2.3 marca qué reparto necesita confirmación antes de tratarse como cerrado |
...
|---|---|---|---|
| 1.0 | 2026-07-27 | Versión inicial, derivada del SOLUTION-INTAKE-SelfHosted-Service-Core-v1.0. Cinco fases, diecinueve épicas, trece etapas identificadas y seis transiciones con criterios verificables. El reparto de EP-12, EP-14 y EP-17 entre las fases 2 y 3 queda marcado como derivación pendiente de confirmación | Product Manager Senior (AG-00) con Analista de Negocio Senior (AG-01) |
...
| 1.1 | 2026-07-28 | Propagación de las decisiones del 2026-07-28 consolidadas en el SOLUTION-INTAKE v1.2. Se incorpora §2.4, «Capacidades sin fase asignada», con EP-23 y EP-24 para F-23 y F-24: el intake declara que su ubicación en un alcance y en un corte vertical es una pendiente, porque los diez cortes del Alcance 1 están cerrados y ninguna figura entre ellos, de modo que este roadmap no se la inventa y registra en cambio sus dependencias y quién resuelve. §2.2 y §3 suman las dos épicas sin fase, y las épicas pasan de diecinueve a veintiuna. EP-14 se reformula por la redefinición del catálogo (D-7). El criterio de transición a la Fase 0 deja de citar CL-04 y CL-15, cerrados el 2026-07-28. Sube a 1.1 porque el documento ya fue consumido por 01-Necesidades-Negocio; la 1.0 queda archivada en `_legacy/2026-07-28/`. Las citas actualizadas son las vivas —cabecera, cuerpo y enlaces navegables—; las filas anteriores de este control de cambios conservan la versión del intake y los nombres de archivo contra los que se trabajó cada día, porque son parte del hecho registrado. | Product Manager Senior (AG-00) con Analista de Negocio Senior (AG-01) |
| 1.2 | 2026-07-28 | Propagación de la segunda pasada sobre el mecanismo de variables del SOLUTION-INTAKE v1.2. §2.4 revisa las consecuencias de planificación de EP-23 y EP-24: la unificación del vínculo invierte la relación que este roadmap suponía entre el lienzo y las referencias, porque trazar una arista pasó a ser escribir una referencia y el corte del lienzo, que es del primer alcance, necesita el mecanismo al menos en su forma mínima. Se declara la tensión y las dos salidas posibles, sin asignarle fase a EP-24, que sigue siendo una pendiente del intake. EP-24 declara además que es el mecanismo con el que se traza un vínculo en el lienzo | Product Manager Senior (AG-00) con Analista de Negocio Senior (AG-01) |
| 1.3 | 2026-07-28 | Propagación de la tercera pasada sobre el mecanismo de variables del SOLUTION-INTAKE. EP-06 y su fila de dependencias dejan de afirmar que el orden de arranque se deduce de las aristas: la espera es ahora una propiedad declarada sobre cada arista. §2.4 corrige la forma mínima que el corte del lienzo necesita, que ya no incluye el puerto, y registra que la tensión entre ese corte y EP-24 se aflojó, porque una arista puede entregar la dependencia de orden sin el mecanismo completo de referencias | Product Manager Senior (AG-00) con Analista de Negocio Senior (AG-01) |
| 1.4 | 2026-07-28 | Cuarta pasada del SOLUTION-INTAKE, de terminología. Se califica como proyecto de código el criterio de cobertura de la transición de la Fase 1 a la Fase 2, que es la única mención del documento en ese sentido. La cabecera califica el proyecto de código principal. Se adopta además la convención de citas de la solución: las citas en prosa van sin sufijo de versión y el nombre versionado queda reservado a la identidad del propio documento, a la trazabilidad upstream de la cabecera y a los enlaces navegables, que necesitan el nombre de archivo real. Es lo que corta la cascada por la que un documento subía de versión sin tener una línea propia que corregir. | Product Manager Senior (AG-00) con Analista de Negocio Senior (AG-01) |
| 1.5 | 2026-07-28 | Quinta y última pasada del SOLUTION-INTAKE. §2.2, §2.4 y §3 suman EP-25 para F-25, sin fase asignada, que es la misma pendiente en la que ya estaban EP-23 y EP-24 y con la que el intake la registra junta; las épicas pasan de veintiuna a veintidós. §2.4 agrega la consecuencia de orden que la capacidad nueva trae: F-25 va después de las otras dos, porque las condiciones que advierte son en su mayoría sobre variables compartidas y referencias, y adelantarla la dejaría sin nada que detectar | Product Manager Senior (AG-00) con Analista de Negocio Senior (AG-01) |
