...
| Documento | Necesidades-Negocio-v1.1.md |
| Versión | 1.1 |
| Estado | Propuesto |
| Fecha | 2026-07-28 |
...
| NB-05 | Arranque previsible: orden deducido y conflictos de dirección detectados antes de fallar | Must Have | CU-18 a CU-21 | Propuesto | [NB-05](Necesidades-De-Negocio/NB-05-Arranque-Sin-Conflictos-De-Direccion-v1.1.md) |
| NB-06 | Cambios de configuración revisados antes de aplicarse y aplicados en un solo lote | Must Have | CU-22 a CU-25 | Propuesto | [NB-06](Necesidades-De-Negocio/NB-06-Cambios-Revisados-Y-Aplicados-En-Lote-v1.1.md) |
...
Las cuatro métricas de éxito declaradas en SOLUTION-INTAKE §8 y recogidas en `Vision-Producto-v1.1.md` §6 se reparten así:
...
| 00-Contexto | [Vision-Producto-v1.1.md](../00-Contexto/Vision-Producto-v1.1.md), [Alcance-Proyecto-v1.1.md](../00-Contexto/Alcance-Proyecto-v1.1.md), [Roadmap-Producto-v1.1.md](../00-Contexto/Roadmap-Producto-v1.1.md) | Propuesto |
...
Las ocho necesidades suman cuarenta y un criterios de éxito. Treinta y nueve toman su número de una métrica de negocio declarada, de un umbral no funcional declarado o del dimensionamiento verificado del intake. Los dos restantes son derivaciones de este catálogo, están marcados `[D]` en la tabla de la necesidad correspondiente y en la nota al pie de su §5, y requieren confirmación explícita del cliente antes de tratarse como cerrados.
...
| F-09, escalado manual, se ubica en NB-06 y no en NB-07 | Cambiar réplicas o límites de recursos es una edición de configuración que entra en el conjunto de cambios pendientes y provoca un reemplazo de contenedor: comparte circuito de revisión, informe de impacto y ventana de indisponibilidad con el resto de los cambios. NB-07 conserva la observación del consumo, que es un dolor distinto y de otra fase: `Roadmap-Producto-v1.1.md` §2.2 ubica F-09 en la Fase 1 y F-12 en la Fase 2 |
