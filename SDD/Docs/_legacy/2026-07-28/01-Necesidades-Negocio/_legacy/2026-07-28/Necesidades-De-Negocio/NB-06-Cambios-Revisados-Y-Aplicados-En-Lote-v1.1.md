...
| Documento | NB-06-Cambios-Revisados-Y-Aplicados-En-Lote-v1.1.md |
| Versión | 1.1 |
| Estado | Propuesto |
| Fecha | 2026-07-28 |
| Autor | Analista de Negocio Senior (AG-01) |
| Trazabilidad upstream | SOLUTION-INTAKE §3 (diferenciador 3), §4 (F-07, F-09), §5 (historia 5), §7 (CL-04 y CL-06; CL-04 resuelto el 2026-07-28 por la decisión D-1), §9 (exclusión 2), §17.2 P.11, anexos E-5, E-16 (RN-12, RN-13, RN-18, RN-19); `Vision-Producto-v1.1.md` §3 (DV-03); `Alcance-Proyecto-v1.1.md` §4.1, §5.1 |
...
- La consecuencia de un cambio se conoce antes de ejecutarlo y no después, lo que habilita decidir con información en lugar de descubrir. El alcance de esa consecuencia incluye a los servicios que toman de otro el valor de una variable, y no sólo a los que dependen de su dirección.
...
- No hay ningún momento en el que se declare, antes de ejecutar, qué servicios quedan afectados por un cambio, cualquiera sea el camino por el que ese cambio los alcance: porque dependen de la dirección y el puerto que cambió, o porque toman el valor de una variable que cambió.
...
|---|---|---|---|
| Reemplazos por sesión de edición | Aplicaciones de cambios ejecutadas por una sesión de edición que toca varios servicios de un mismo proyecto | 1 aplicación por lote, en lugar de una por cambio | Al cierre de la etapa de cambios pendientes |
