...
| Documento | NB-01-Visibilidad-Unificada-De-La-Arquitectura-v1.3.md |
| Versión | 1.3 |
| Estado | Propuesto |
| Fecha | 2026-07-28 |
...
| Integridad de la arquitectura ante un renombrado | Dependencias declaradas que siguen siendo válidas después de renombrar un servicio del proyecto, sobre el total de las que lo apuntaban | 100 % de las dependencias | Al cierre de la etapa de servicios del proyecto |
