...
| Documento | NB-01-Visibilidad-Unificada-De-La-Arquitectura-v1.4.md |
| Versión | 1.4 |
| Estado | Propuesto |
| Fecha | 2026-07-28 |
| Autor | Analista de Negocio Senior (AG-01) |
| Trazabilidad upstream | SOLUTION-INTAKE §1, §3, §4 (F-02, F-03, F-04), §5 (historias 2 y 3), §6 (flujo 1), §12, §17.1 P.10, §19, la segunda y la tercera pasada sobre la decisión D-6 del 2026-07-28 y sus anexos E-4 y E-19; `Vision-Producto-v1.1.md` §1, §3; `Alcance-Proyecto-v1.1.md` §4.1 |
...
- Cambiarle el nombre a un servicio obliga a revisar y corregir a mano todo lo que lo nombraba, y lo que se pase por alto se rompe en silencio.
...
| Integridad de la arquitectura ante un renombrado | Dependencias declaradas que siguen siendo válidas después de renombrar un servicio del proyecto SelfHosted, sobre el total de las que lo apuntaban | 100 % de las dependencias | Al cierre de la etapa de servicios del proyecto |
...
La séptima fila mide una promesa que el registro debe sostener: que una dependencia declarada lo esté sobre el servicio y no sobre la cadena de caracteres con la que hoy se lo nombra. Es lo que hace que renombrar sea una operación segura y no una que obliga a revisar el resto del proyecto.
