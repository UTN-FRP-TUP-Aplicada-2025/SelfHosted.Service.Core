...
| Documento | NB-06-Cambios-Revisados-Y-Aplicados-En-Lote-v1.0.md |
| Versión | 1.0 |
| Estado | Propuesto |
| Fecha | 2026-07-27 |
| Autor | Analista de Negocio Senior (AG-01) |
| Trazabilidad upstream | SOLUTION-INTAKE §3 (diferenciador 3), §4 (F-07, F-09), §5 (historia 5), §7 (CL-06), §9 (exclusión 2), §17.2 P.11, anexos E-5, E-16 (RN-12, RN-13, RN-18, RN-19); `Vision-Producto-v1.0.md` §3 (DV-03); `Alcance-Proyecto-v1.0.md` §4.1, §5.1 |
...
- La consecuencia de un cambio se conoce antes de ejecutarlo y no después, lo que habilita decidir con información en lugar de descubrir.
...
- No hay ningún momento en el que se declare, antes de ejecutar, qué servicios quedan afectados por un cambio.
