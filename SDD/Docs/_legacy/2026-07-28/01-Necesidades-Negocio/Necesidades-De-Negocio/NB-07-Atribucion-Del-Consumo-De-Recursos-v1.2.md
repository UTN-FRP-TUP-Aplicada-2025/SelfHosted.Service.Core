...
| Documento | NB-07-Atribucion-Del-Consumo-De-Recursos-v1.2.md |
| Versión | 1.2 |
| Estado | Propuesto |
| Fecha | 2026-07-28 |
| Autor | Analista de Negocio Senior (AG-01) |
| Trazabilidad upstream | SOLUTION-INTAKE §1, §4 (F-12), §5 (historia 8), §7 (CL-02), §9 (exclusión 6), §10, §11 (RG-04, RG-08), §17.1 P.10, §17.3 P.10, anexo E-19; `Vision-Producto-v1.1.md` §7 (RE-06), §8 (RG-04, RG-08); `Alcance-Proyecto-v1.1.md` §4.1, §5.1 |
...
| Niveles de lectura disponibles | Capas del tablero que se recorren sin salir de la solución: estado del servidor, vista por proyecto SelfHosted y vista por contenedor | 3 de 3 capas | Al cierre de la Fase 2 |
...
| NB-07 | CU-27 vista general de estado por proyecto SelfHosted y vista por contenedor, con su consumo | SelfHosted-Web | a generar |
...
- Depende de: NB-01, porque el tablero atribuye consumo a servicios y proyectos SelfHosted declarados; y NB-04, porque sólo se observa el estado de contenedores efectivamente desplegados.
...
| 1.1 | 2026-07-28 | Ninguna de las siete decisiones del agente humano del proyecto del 2026-07-28 alcanza a esta necesidad: su enunciado, sus criterios de éxito, sus casos de uso previstos y sus dependencias quedan sin cambios. El único cambio es la actualización de las dos citas a documentos de `00-Contexto`, que pasaron a la versión 1.1 en su actualización paralela y cuyas referencias habrían quedado apuntando a archivos inexistentes. La versión sube por esa corrección, no por uniformidad con el resto del catálogo | Analista de Negocio Senior (AG-01) |
